...
{
  "personalInfo": {
    "name": { "value": string, "confidence": number, "standardization": string | null },
    "email": { "value": string, "confidence": number, "standardization": string | null },
    "phone": { "value": string, "confidence": number, "standardization": string | null },
    "location": { "value": string | null, "confidence": number, "standardization": string | null },
    "linkedin": { "value": string | null, "confidence": number, "standardization": string | null },
    "github": { "value": string | null, "confidence": number, "standardization": string | null },
    "website": { "value": string | null, "confidence": number, "standardization": string | null },
    "summary": { "value": string | null, "confidence": number, "standardization": string | null }
  },
  "skills": [
    {
      "name": { "value": string, "confidence": number, "standardization": string | null },
      "category": { "value": string | null, "confidence": number, "standardization": string | null },
      "proficiency": { "value": string | null, "confidence": number, "standardization": string | null },
      "yearsOfExperience": { "value": number | null, "confidence": number, "standardization": string | null }
    }
  ],
  "workExperience": [
    {
      "company": { "value": string, "confidence": number, "standardization": string | null },
      "title": { "value": string, "confidence": number, "standardization": string | null },
      "location": { "value": string | null, "confidence": number, "standardization": string | null },
      "dates": {
        "startDate": { "value": string | null, "confidence": number, "standardization": string | null },
        "endDate": { "value": string | null, "confidence": number, "standardization": string | null },
        "durationInMonths": { "value": number | null, "confidence": number, "standardization": string | null },
        "current": { "value": boolean, "confidence": number, "standardization": string | null }
      },
      "responsibilities": { "value": string[], "confidence": number, "standardization": string | null },
      "technologies": { "value": string[], "confidence": number, "standardization": string | null },
      "achievements": { "value": string[], "confidence": number, "standardization": string | null }
    }
  ],
  "education": [
    {
      "institution": { "value": string, "confidence": number, "standardization": string | null },
      "degree": { "value": string, "confidence": number, "standardization": string | null },
      "field": { "value": string, "confidence": number, "standardization": string | null },
      "dates": {
        "startDate": { "value": string | null, "confidence": number, "standardization": string | null },
        "endDate": { "value": string | null, "confidence": number, "standardization": string | null },
        "durationInMonths": { "value": number | null, "confidence": number, "standardization": string | null },
      ...
      "gpa": { "value": string | null, "confidence": number, "standardization": string | null },
      "coursework": { "value": string[] | null, "confidence": number, "standardization": string | null },
      "achievements": { "value": string[] | null, "confidence": number, "standardization": string | null }
    }
  ],
  "projects": [
    {
      "name": { "value": string, "confidence": number, "standardization": string | null },
      "description": { "value": string, "confidence": number, "standardization": string | null },
      "technologies": { "value": string[], "confidence": number, "standardization": string | null },
      "urls": { "value": string[] | null, "confidence": number, "standardization": string | null },
      "dates": { 
        "value": {
          "startDate": { "value": string | null, "confidence": number, "standardization": string | null },
          "endDate": { "value": string | null, "confidence": number, "standardization": string | null },
      ...
      "role": { "value": string | null, "confidence": number, "standardization": string | null }
    }
  ],
  "certifications": [
    {
      "name": { "value": string, "confidence": number, "standardization": string | null },
      "issuer": { "value": string | null, "confidence": number, "standardization": string | null },
      "date": { "value": string | null, "confidence": number, "standardization": string | null },
      "expiryDate": { "value": string | null, "confidence": number, "standardization": string | null },
      "id": { "value": string | null, "confidence": number, "standardization": string | null }
    }
  ],
  "languages": [
    {
